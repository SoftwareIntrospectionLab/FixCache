...
public class CacheItem {
	...
	public CacheItem(int eid, int cid, int pid, String cdate, CacheReason r, Cache p)
	{
		entityId = eid;
		reason = r;
		parent = p;
		update(cid, pid, cdate, p.getStartDate());
	}

	public void update(int cid, int pid, String cdate, String sdate){
		loadDate = Calendar.getInstance().getTime(); // XXX fix this, deprecated method
		LOC = findLoc(entityId, cid);
		number = findNumber(entityId, pid, cdate, sdate);
	}
