...
public class CochangeTest {
	...
	public void testCoChange() {
		ArrayList<Integer> cochanges1 = CoChange.getCoChangeFileList(5,
		...
		ArrayList<Integer> cochanges2 = CoChange.getCoChangeFileList(1,
		...
		ArrayList<Integer> cochanges3 = CoChange.getCoChangeFileList(7,
