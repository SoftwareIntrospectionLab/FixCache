...
public class CochangeTest {
	...
	{
		ArrayList<Integer> cochanges1 = CoChange.getCoChangeFileList(5, "2009-10-24 09:50:26.0", 3);
		assertEquals(cochanges1.size(),2);
		assertEquals(cochanges1.get(0).intValue(),1);
		assertEquals(cochanges1.get(1).intValue(),2);
		ArrayList<Integer> cochanges2 = CoChange.getCoChangeFileList(1, "2009-10-24 07:51:22.0", 4);
		...
		ArrayList<Integer> cochanges3 = CoChange.getCoChangeFileList(7, "2009-10-23 14:29:05.0", 5);
